...
public class Configs {
    ...
    public static final URL DemoServerUrl(){
        try {
            return new URL("https://" + USERNAME + ":" + ACCESS_KEY + "@api.Demo.com/wd/hub");
    ...
    public static DesiredCapabilities desiredCapabilitiesAndroidApp(){
        ...
        capabilities.setCapability("deviceOrientation", "portrait");
        capabilities.setCapability("captureScreenshots", true);
        capabilities.setCapability("app", "https://s3-ap-southeast-1.amazonaws.com/Demo-devvn/apps-test/demo/com.dozuki.ifixit.apk");
        capabilities.setCapability("deviceGroup", "Demo");
        capabilities.setCapability("deviceName", "Galaxy S5");
        capabilities.setCapability("platformName", "Android");
    ...
    public static DesiredCapabilities desiredCapabilitiesiOSApp(){
        ...
        capabilities.setCapability("deviceOrientation", "portrait");
        capabilities.setCapability("captureScreenshots", true);
        capabilities.setCapability("app", "https://s3-ap-southeast-1.amazonaws.com/Demo-devvn/apps-test/demo/iFixit.ipa");
        capabilities.setCapability("deviceGroup", "Demo");
        capabilities.setCapability("deviceName", "iPhone 7");
        capabilities.setCapability("platformName", "iOS");
        return capabilities;
